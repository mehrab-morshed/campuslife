...
def main():
  ...
  for i in range(15, 31):
    ...
    google_df = loadData("./google-days/daym4d"+str(i)+"-googleactivity.csv")
    ...
    googleactivity_df.to_csv("userepochs-daym4d" + str(i) + ".csv", sep='\t', index=False)
  ...
  for i in range(1, 7):
    ...
    google_df = loadData("./google-days/daym5d"+str(i)+"-googleactivity.csv")
    googleactivity_df = googleactivity(google_df)
    ...
    googleactivity_df.to_csv("userepochs-daym5d" + str(i) + ".csv", sep='\t', index=False)
